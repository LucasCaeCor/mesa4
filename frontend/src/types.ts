...
export type Product = { id: string; name: string; description?: string; priceCents: number; imageUrl?: string; featured: boolean; suggestAtCheckout: boolean; cartSuggestionKind?: "DRINK" | "EXTRA" | null; cartSuggestionPriority?: number; soldOut: boolean; optionGroups: ProductOptionGroup[] };
